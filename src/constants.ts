...
export const BALL_WALL_BOUNCE = 0.85;  // velocity coefficient on wall/ceiling bounce
export const BALL_NET_BOUNCE = 0.65;   // velocity coefficient when ball clips net top
export const BALL_NET_SIDE_BOUNCE = 0.7;
